% Curve with hue Variation with 6 different Sigma values for distances.
% Each RGB has different distence values. 2017/4/21
clear all;
close all;
clc;
...
ADx=[0.708 0.170 0.131]; %Adobe RGB gamut
