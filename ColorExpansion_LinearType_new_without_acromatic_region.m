% image based linear extension without considering achromatic region change
...
charmode = 0;
Nonlinearmode = 0;    % When 0, it is Linear mode/ When 1, it is Curve mode
...
if charmode ==1,
    ...
    filename = ['reformatted_images\\13'];
    formatfile = ['.jpg'];
    readfilename = [filename formatfile];
...
for i=1:imgSize,
        ...
        if inR(i)==1,      
            ...
            if Nonlinearmode == 0;  %%%% linear expansion
                
                 dir = (sRGB_xy(i,:)' - Origin)/norm((sRGB_xy(i,:)' - Origin));
                ...
                plot(x,y,'go','markersize',4,'LineWidth',2), hold on,
                plot(tarPnt(1),tarPnt(2),'bo','markersize',4,'LineWidth',2), hold on,
                line([x tarPnt(1)],[y tarPnt(2)],'Color','b','LineWidth',2);
                
                hold on;
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
          
                
            else  %%%% Non-linear expansion
        ...
        if inG(i)==1,   
            ...
            if Nonlinearmode == 0;  %%%% linear expansion
                ...
                plot(x,y,'bo','markersize',4,'LineWidth',2), hold on,
                plot(tarPnt(1),tarPnt(2),'ro','markersize',4,'LineWidth',2), hold on,
                line([x tarPnt(1)],[y tarPnt(2)],'Color','r','LineWidth',2);            
                hold on;
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        if inB(i)==1,
            if Nonlinearmode == 0;  %%%% linear expansion
                ...
                plot(x,y,'ro','markersize',4,'LineWidth',2), hold on,
                plot(tarPnt(1),tarPnt(2),'go','markersize',4,'LineWidth',2), hold on,
                line([x tarPnt(1)],[y tarPnt(2)],'Color','g','LineWidth',2);            
                hold on;
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
