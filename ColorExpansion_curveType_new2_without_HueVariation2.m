...
% controlling the saturation ratio according to thee degree of curvature
% The bigger the curvature is, the smaller the saturation ratio is
...
if charmode ==1,
    ...
    filename = ['reformatted_images\\cow-1937101_640'];
    formatfile = ['.jpg'];
    readfilename = [filename formatfile];
...
yn = normpdf(xn,R_disMean,sig1);
Rdegree_ratio1 = MaxStepR/max(yn);

xn_1 = [0:0.001:R_disMean];
yn_1 = normpdf(xn_1,R_disMean,sig1)*Rdegree_ratio1;

yn = normpdf(xn,R_disMean,sig2);
Rdegree_ratio2 = MaxStepR/max(yn);

xn_2 = [R_disMean+0.001:0.001:R_Maxdis];
yn_2 = normpdf(xn_2,R_disMean,sig2)*Rdegree_ratio2;
...
yn = normpdf(xn,B_disMean,sig5);
Bdegree_ratio1 = MaxStepB/max(yn);

xn_1 = [0:0.001:B_disMean];
yn_1 = normpdf(xn_1,B_disMean,sig5)*Bdegree_ratio1;

yn = normpdf(xn,B_disMean,sig6);
Bdegree_ratio2 = MaxStepB/max(yn);

xn_2 = [B_disMean+0.001:0.001:B_Maxdis];
yn_2 = normpdf(xn_2,B_disMean,sig6)*Bdegree_ratio2;
