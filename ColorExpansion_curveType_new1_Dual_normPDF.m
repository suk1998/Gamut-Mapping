...
if charmode ==1,
    ...
    filename = ['reformatted_images\\pens-1743305_640'];
    formatfile = ['.jpg'];
    readfilename = [filename formatfile];
...
yn = normpdf(xn,G_disMean,sig1);
Gdegree_ratio1 = MaxStep/max(yn);

xn_1 = [0:0.001:G_disMean];
yn_1 = normpdf(xn_1,G_disMean,sig1)*Gdegree_ratio1;

yn = normpdf(xn,G_disMean,sig2);
Gdegree_ratio2 = MaxStep/max(yn);

xn_2 = [G_disMean+0.001:0.001:G_Maxdis];
yn_2 = normpdf(xn_2,G_disMean,sig2)*Gdegree_ratio2;
...
yn = normpdf(xn,B_disMean,sig2);
Bdegree_ratio2 = MaxStep/max(yn);

xn_2 = [B_disMean+0.001:0.001:B_Maxdis];
yn_2 = normpdf(xn_2,B_disMean,sig2)*Bdegree_ratio2;
