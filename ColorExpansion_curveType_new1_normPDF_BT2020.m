% Curve with hue Variation. Gaussian Distribution as a step
% expanding to BT2020
clear all;
close all;
clc;

Sx=[0.640 0.300 0.150]; %sRGB gamut
Sy=[0.330 0.600 0.060];
ADx=[0.708 0.170 0.131]; %BT 2020 RGB gamut
ADy=[0.292 0.797 0.046];
...
%%%%%%%%%%%%%%%%% distance & curvature distribution %%%%%%%%%%%%%%%%%%%%%%%
...
%                 if r_sq <= min_dis,
%                     r_sq = 0.00000001;
%                 elseif (r_sq>min_dis)&&(r_sq<=max_dis),
%                     r_sq = 0.0050;
%                 else
%                     r_sq = 0.00000001;
%                 end         
                r_sq = normpdf(r_sq,R_disMean,sig)*Rdegree_ratio;
            end
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%                     r_sq = 0.00000001;
%                 end   
                r_sq = normpdf(r_sq,G_disMean,sig)*Gdegree_ratio;
            end
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%                     r_sq = 0.00000001;
%                 end          
                r_sq = normpdf(r_sq,B_disMean,sig)*Bdegree_ratio;
            end
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
